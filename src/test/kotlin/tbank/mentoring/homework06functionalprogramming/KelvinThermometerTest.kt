...
import tbank.mentoring.homework06functionalprogramming.KelvinThermometer.Converter.kelvinToCelsius
...
class KelvinThermometerTest {
    ...
    fun kelvinToCelsiusTest() {
        ...
        assertEquals(
            ...
            /* actual = */ KelvinThermometer(tempInKelvin).convert { it - 273.15 },
            /* delta = */ 0.1
        )
    }
    ...
    fun kelvinToFahrenheitTest() {
        ...
        assertEquals(
            ...
            /* actual = */ KelvinThermometer(tempInKelvin).convert { kelvinToFahrenheit(it) },
            /* delta = */ 0.1
        )
    }
}